...
- Optionally, an entry appended to `process/tasks/<task>/implementation-log.md` per
  `.misc/templates/implementation-log.md` (template MUST be read end-to-end on the
