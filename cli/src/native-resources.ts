...
const resourceContext = (resources: AgentResources): string =>
	[
		...
		"Project instructions govern every role. Follow relevant linked engineering/testing standards before decisions, edits, or review; a self-contained brief limits task scope, not applicable standards. Reuse supplied text and read only missing relevant sections. If essential guidance is inaccessible or conflicting, report the specific gap rather than guessing.",
